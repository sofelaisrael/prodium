...
import { getSortDesc, setSortDesc as setSortPref } from '../sortPref'
...
export default function Episodes() {
  ...
  const [sortDesc, setSortDesc] = useState(getSortDesc())
  ...
  return (
    <div className="animate-fade-in py-12 mx-5 md:mx-20">
      ...
      <div className="mb-10 flex items-center gap-3">
        ...
        <button
          onClick={() => { const next = !sortDesc; setSortDesc(next); setSortPref(next) }}
