...
export default function Articles() {
  ...
  return (
    <div className="py-10">
      <div className="mb-10">
        <h1 className="text-[32px] font-semibold tracking-tight text-neutral-900">Articles</h1>
        <p className="mt-2 text-[15px] text-neutral-500">Explore all published stories.</p>
      </div>
      ...
      {loading ? (
        ...
        <div className="rounded-xl border border-dashed border-neutral-200 py-20 text-center">
          <p className="text-[14px] text-neutral-400">No articles found.</p>
        </div>
      ) : (
